...
describe GitHub do
  ...
  describe "handle defaults" do
    ...
    it "should handle :account references" do
      GitHub.merge_reference_with_default({:account => "Koronen", :repo => nil, :issue => nil}, "#withdefault").should == {:account => "Koronen", :repo => nil, :issue => nil}
    ...
    it "should handle (:account)/:repo references" do
      GitHub.merge_reference_with_default({:account => nil, :repo => "spargris", :issue => nil}, "#withdefault").should == {:account => "Frost", :repo => "spargris", :issue => nil}
      GitHub.merge_reference_with_default({:account => "Koronen", :repo => "spargris", :issue => nil}, "#withdefault").should == {:account => "Koronen", :repo => "spargris", :issue => nil}
    ...
    it "should handle (:account)(/:repo)#:issue references" do
      GitHub.merge_reference_with_default({:account => nil, :repo => nil, :issue => 2}, "#withdefault").should == {:account => "Frost", :repo => "url-grabber", :issue => 2}
      GitHub.merge_reference_with_default({:account => nil, :repo => "spargris", :issue => 2}, "#withdefault").should == {:account => "Frost", :repo => "spargris", :issue => 2}
